...
```js
// next.config.js
const withNextra = require("nextra")("nextra-theme-docs", "./theme.config.mjs");
...
Finally, add the `i18n` option to your `theme.config.mjs` to configure the language dropdown:
